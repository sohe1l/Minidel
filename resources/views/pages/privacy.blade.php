...
<div>1.1 Our website uses cookies.</div>
<div>1.2 By using our website and agreeing to this policy, you consent to our use of cookies in accordance with the terms of this policy.</div>

<h4>2.  Credit</h4>
<div>2.1 This document is created by SEQ Legal LLP.</div>

<h4>3.  About cookies</h4>
<div>3.1 A cookie is a file containing an identifier (a string of letters and numbers) that is sent by a web server to a web browser and is stored by the browser. The identifier is then sent back to the server each time the browser requests a page from the server.</div>

<div>3.2 Cookies may be either "persistent" cookies or "session" cookies: a persistent cookie will be stored by a web browser and will remain valid until its set expiry date, unless deleted by the user before the expiry date; a session cookie, on the other hand, will expire at the end of the user session, when the web browser is closed. </div>

<div>3.3 Cookies do not typically contain any information that personally identifies a user, but personal information that we store about you may be linked to the information stored in and obtained from cookies.</div>

<div>3.4 Cookies can be used by web servers to identify and track users as they navigate different pages on a website and identify users returning to a website.</div>

<h4>4.  Our cookies</h4>

<div>4.1 We use both session and persistent cookies on our website.</div>


<h4>5.  Analytics cookies</h4>

<div>5.1 We use Google Analytics to analyse the use of our website.</div>
<div>5.2 Our analytics service provider generates statistical and other information about website use by means of cookies.</div>
<div>5.3 The analytics cookies used by our website have the following names: [_utma, _utmb, _utmc and _utmz].</div>
<div>5.4 The information generated relating to our website is used to create reports about the use of our website.</div>
<div>5.5 Our analytics service provider's privacy policy is available at: http://www.google.com/policies/privacy/.</div>

<h4>6.  Third party cookies</h4>
<div>6.1 Our website also uses third party cookies.</div>
<div>6.2 We publish Google AdSense interest-based advertisements on our website. These are tailored by Google to reflect your interests. To determine your interests, Google will track your behaviour on our website and on other websites across the web using the DoubleClick cookie. / We publish Google AdSense advertisements on our website. To determine your interests, Google will track your behaviour on our website and on other websites across the web using the DoubleClick cookie. This behaviour tracking allows Google to tailor the advertisements you see on other websites to reflect your interests (we do not publish interest-based advertisements on this website).] You can view, delete or add interest categories associated with your browser by visiting: http://www.google.com/settings/ads/. You can also opt out of the AdSense partner network cookie using those settings or using the NAI's (Network Advertising Initiative's) multi-cookie opt-out mechanism at: http://www.networkadvertising.org/choices/. However, these opt-out mechanisms themselves use cookies, and if you clear the cookies from your browser your opt-out will not be maintained. To ensure that an opt-out is maintained in respect of a particular browser, you may wish to consider using the Google browser plug-in available at: https://www.google.com/settings/ads/plugin.</div>

<h4>7.  Blocking cookies</h4>

<div>7.1 Most browsers allow you to refuse to accept cookies; for example:<br>
...
(b) in Firefox (version 36) you can block all cookies by clicking "Tools", "Options", "Privacy", selecting "Use custom settings for history" from the drop-down menu, and unticking "Accept cookies from sites"; and<br>
...
<div>7.2 Blocking all cookies will have a negative impact upon the usability of many websites.</div>
<div>7.3 If you block cookies, you will not be able to use all the features on our website.</div>

<h4>8.  Deleting cookies</h4>
<div>8.1 You can delete cookies already stored on your computer; for example:<br>
...
(b) in Firefox (version 36), you can delete cookies by clicking "Tools", "Options" and "Privacy", then selecting "Use custom settings for history" from the drop-down menu, clicking "Show Cookies", and then clicking "Remove All Cookies"; and<br>
...
<div>8.2 Deleting cookies will have a negative impact on the usability of many websites.</div>

<h4>9.  Our details</h4>
<div>9.1 This website is owned and operated by Iconic Web Works.</div>
<div>9.2 We are registered in Ajman Free Zone under registration number 16423, and our registered office is at Amber Gem Tower.</div>
<div>9.3 Our principal place of business is at Ajman.</div>
<div>9.4 You can contact us by writing to the business address given above, by using our website contact form, by email to hello@minidel.com</div>
